                ...
                <%-- Sidebar (repetido por simplicidad) --%>
                    ...
                    <main class="main-content">
                        <%-- Header --%>
                            <header class="header">
                                <div>
                                    <h2><span class="highlight">Conversación con ${conversacion.participante}</span>
                                    </h2>
                            ...
                            <div class="conversation-detail-container">
                                <div class="conversation-header-detail">
                                    ...
                                    <div class="actions-group"> <%-- Agrupamos los botones --%>
                                            <a href="/mensajes/interna" class="btn btn-secondary btn-back"><i
                                                    class="fas fa-arrow-left"></i> Volver</a>
                                            <%-- NUEVO BOTÓN DE RESPONDER QUE REDIRIGE --%>
                                                <a href="/mensajes/responder-form/${conversacion.id}"
                                                    class="btn btn-primary btn-reply-redirect"><i
                                                        class="fas fa-reply"></i> Responder</a>
                                    </div>
                                </div>
                                    ...
                                    <c:forEach items="${conversacion.mensajes}" var="mensaje">
                                        <div class="message-item ${mensaje.esEnviadoPorMi ? 'sent' : 'received'}">
                                            <div class="message-bubble">
                                                ...
                                                <span class="message-meta">${mensaje.remitente} -
                                                    ${mensaje.fechaHora}</span>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
