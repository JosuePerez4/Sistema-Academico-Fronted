...
<div class="container">
    ...
    <main class="main-content">
        ...
        <div style="background:white;border-radius:30px;padding:40px 50px;max-width:1100px;margin:0 auto;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
            ...
            <p style="font-size:22px;font-weight:700;margin-bottom:10px;">Especialidad: <span style="font-weight:400;">Bases de datos</span></p>
            <p style="font-size:22px;font-weight:700;margin-bottom:10px;">Carga Horaria: <span style="font-weight:400;">40 Horas</span></p>
            <p style="font-size:22px;font-weight:700;margin-bottom:10px;">Título Profesional: <span style="font-weight:400;">PhD. Computer Science</span></p>
            <p style="font-size:22px;font-weight:700;margin-bottom:10px;">Años de Experiencia: <span style="font-weight:400;">10</span></p>
            <p style="font-size:22px;font-weight:700;margin-bottom:30px;">Tipo de Contrato: <span style="font-weight:400;">Cátedra</span></p>
