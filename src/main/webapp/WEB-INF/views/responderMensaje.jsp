                        ...
                        <%-- Header --%>
                            ...
                            <div class="compose-message-container">
                                <%-- El action debe apuntar al endpoint de enviar respuesta con el ID de la conversación
                                    --%>
                                    <form action="/mensajes/enviar-respuesta/${conversacion.id}" method="post"
                                        class="message-form">
                                        <div class="form-group">
                                            <label for="to">Para:</label>
                                            <%-- Campo "Para" no editable para una respuesta --%>
                                                <input type="text" id="to" name="to"
                                                    value="${conversacion.participante}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="subject">Asunto:</label>
                                            <%-- Asunto pre-rellenado, quizás con "Re: " --%>
                                                <input type="text" id="subject" name="subject"
                                                    value="Re: ${conversacion.asunto}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="message-content">Tu Respuesta:</label>
                                            <textarea id="message-content" name="replyContent" rows="10"
                                                placeholder="Escribe tu respuesta aquí..." required></textarea>
                                        </div>
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="fas fa-paper-plane"></i> Enviar Respuesta</button>
                                            <a href="/mensajes/conversacion/${conversacion.id}"
