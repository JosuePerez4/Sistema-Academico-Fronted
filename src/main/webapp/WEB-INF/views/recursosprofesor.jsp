...
<div class="container">
    <aside class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li class="active"><a href="/profesor/recursos">Recursos Académicos</a></li>
            </ul>
        </nav>
    ...
    <main class="main-content">
        ...
        <div style="background:white;border-radius:30px;padding:40px 50px;max-width:1100px;margin:0 auto;box-shadow:0 4px 24px rgba(0,0,0,0.07);">
            <h2 style="color:#54a7b9;margin-bottom:30px;">Administrar el préstamo, devolución y mantenimiento de recursos educativos, como libros y equipos.</h2>
            <form id="movimiento-form" style="display:flex;flex-direction:column;gap:20px;max-width:500px;">
                <label style="font-size:18px;font-weight:600;">Recurso disponible
                    <select id="recurso-select" style="margin-top:8px;padding:8px 12px;border-radius:8px;border:1px solid #e7e9ed;width:100%;">
                        <option value="">Cargando...</option>
                    </select>
                </label>
                <label style="font-size:18px;font-weight:600;">Acción
                    <select id="accion-select" style="margin-top:8px;padding:8px 12px;border-radius:8px;border:1px solid #e7e9ed;width:100%;">
                ...
                <label style="font-size:18px;font-weight:600;">Fecha
                    <input id="fecha-input" type="date" style="margin-top:8px;padding:8px 12px;border-radius:8px;border:1px solid #e7e9ed;width:100%;" />
                </label>
                <label style="font-size:18px;font-weight:600;">Observación (opcional)
                    <input id="observacion-input" type="text" style="margin-top:8px;padding:8px 12px;border-radius:8px;border:1px solid #e7e9ed;width:100%;" placeholder="Observaciones sobre el movimiento" />
                </label>
                <button type="submit" style="margin-top:20px;padding:12px 0;background:#54a7b9;color:white;font-size:18px;font-weight:700;border:none;border-radius:8px;">Registrar</button>
            </form>
        </div>
    </main>
</div>
