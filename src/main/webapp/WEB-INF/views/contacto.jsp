            ...
            <div class="container">
                ...
                <main class="main-content">
                    ...
                    <div
                        ...
                        <p style="font-size:22px;font-weight:700;margin-bottom:20px;">Si necesitas ayuda, contáctanos
                            por medio de correo electrónico a:<br>
                            <span style="font-weight:900;">ayuda.divisist3.0@UFPS.edu.com</span><br>
                            o al número<br>
                            <span style="font-weight:900;">+57 3124228724</span>
                        </p>
                        <p style="font-size:20px;font-weight:600;">Cualquier asistencia directa que necesites con tus
                            cursos y/o evaluaciones, puedes comunicarte con tu profesor directamente por medio de la
                            pestaña Mensajes.</p>
                    </div>
                </main>
            </div>
